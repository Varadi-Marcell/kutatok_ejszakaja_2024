...
@Component({
  selector: 'app-parkolo',
  templateUrl: './parkolo.component.html',
  styleUrls: ['./parkolo.component.css']
})
export class ParkoloComponent implements OnInit,AfterViewInit{

  title = 'nyiltnapAngular';
  data: any;

  @ViewChild('scene') scene!: ElementRef;
  @ViewChild(ParkoloSvgComponent) parkoloSvgEl!: ParkoloSvgComponent;
